...
const THINGS = [
  ...
  { img:'https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=300&q=75', title:'Beach Day', desc:'White sand beaches' },
];
      ...
      <section className="hero-section" style={{position:'relative',minHeight:'92vh',overflow:'hidden',display:'flex',alignItems:'center'}}>
        ...
        <div className="container hero-content" style={{position:'relative',zIndex:2,padding:'80px 20px'}}>
          <div className="hero-grid" style={{display:'grid',gridTemplateColumns:'1fr 310px',gap:28,alignItems:'center'}}>
            <div>
              <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:'clamp(32px,5vw,60px)',fontWeight:700,color:'#fff',lineHeight:1.12,marginBottom:10}}>Your Luxury Escape</h1>
              <h2 style={{fontFamily:"'Dancing Script',cursive",fontSize:'clamp(26px,4vw,50px)',color:'#C9933A',marginBottom:20,lineHeight:1.2}}>in Ocho Rios</h2>
